    ...
    const handleSubmit = (event) => {
        ...
        if (password === confirmPassword) {
            ...
            signup(signUpRequest)
                .then(response => {
                    toast.success("Thêm tài khoản nhân viên và tài khoản thành công.");
                ...
                <main style={{ margin: "20px 20px 20px 20px" }}>
                    <div className="card">
                        <div className="card-header">
                            <h5 className="card-title">Thêm nhân viên và tài khoản</h5>
                            <h6 className="card-subtitle text-muted"> Thêm nhân viên và tài khoản của TVL Post.</h6>
                        </div>
