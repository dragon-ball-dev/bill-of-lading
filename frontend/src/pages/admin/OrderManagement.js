                ...
                <div className="main">
                    ...
                    <div className="card">
                        <div className="card-header">
                            ...
                            <h6 className="card-subtitle text-muted"> Quản lý đơn bán của TVL Post.</h6>
                        </div>
                        <div className="card-body">
                            <div id="datatables-buttons_wrapper" className="dataTables_wrapper dt-bootstrap5 no-footer">
                                <div className="row">
                                    ...
                                    <div class="col-12 col-md-6 col-lg-4">
                                        <div className="mb-6">
                                            <label className="form-label" htmlFor="locationId">Chi nhánh</label>
                                            <select
                                                className="form-select"
                                                name="storeId"
                                                value={storeId}
                                ...
                                <div className="row dt-row"><div className="col-sm-12"><table id="datatables-buttons" className="table table-striped dataTable no-footer dtr-inline" style={{ width: "100%" }} aria-describedby="datatables-buttons_info">
                                    <thead>
                                        <tr>
                                            ...
                                            <th className="sorting sorting_asc" tabindex="0" aria-controls="datatables-buttons" rowspan="1" colspan="1" style={{ width: "224px" }}  >Chi nhánh</th>
