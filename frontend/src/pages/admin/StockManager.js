...
import { deleteStock, getAllCategory, getAllProduct, getAllStock } from "../../services/fetch/ApiUtils";
...
function StockManager(props){
    ...
    const fetchData = () => {
        getAllStock(currentPage - 1, itemsPerPage).then(response => {
    ...
    const handleDeleteCategory = (id) => {
        deleteStock(id).then(response => {
            ...
            toast.success("Xóa số lượng sản phẩm trong kho hàng thành công")
            fetchData();
        }).catch(
            error => {
                toast.error((error && error.message) || 'Oops! Có điều gì đó xảy ra. Vui lòng thử lại!');
                ...
                <div className="main">
                    ...
                    <div className="card">
                        <div className="card-header">
                            <h5 className="card-title">Quản lý kho hàng</h5>
                        ...
                        <div className="card-body">
                            <div id="datatables-buttons_wrapper" className="dataTables_wrapper dt-bootstrap5 no-footer"><div className="row"><div className="col-sm-12 col-md-6"><div className="dt-buttons btn-group flex-wrap">
                                <button className="btn btn-secondary buttons-copy buttons-html5" tabindex="0" aria-controls="datatables-buttons" type="button"><a onClick={handleRedirectAddCategory}>Thêm Kho Hàng</a></button>
                            </div></div>
                                <div className="col-sm-12 col-md-6"><div id="datatables-buttons_filter" className="dataTables_filter">
                                    ...
                                    <thead>
                                        <tr>
                                            <th className="sorting sorting_asc" tabindex="0" aria-controls="datatables-buttons" rowspan="1" colspan="1" style={{ width: "224px" }}  >Tên kho hàng</th>
