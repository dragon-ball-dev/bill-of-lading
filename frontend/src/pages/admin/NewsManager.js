...
import { deleteCategory, getAllBanner, getAllCategory, getAllNews } from "../../services/fetch/ApiUtils";
...
function NewsManager(props){
    ...
    const fetchData = () => {
        getAllNews(currentPage - 1, itemsPerPage, searchQuery).then(response => {
                ...
                <div className="main">
                    ...
                    <div className="card">
                        <div className="card-header">
                            <h5 className="card-title">Quản lý tin tức</h5>
                            <h6 className="card-subtitle text-muted"> Quản lý tin tức của TVL Post.</h6>
                        </div>
                        <div className="card-body">
                            <div id="datatables-buttons_wrapper" className="dataTables_wrapper dt-bootstrap5 no-footer"><div className="row"><div className="col-sm-12 col-md-6"><div className="dt-buttons btn-group flex-wrap">
                                <button className="btn btn-secondary buttons-copy buttons-html5" tabindex="0" aria-controls="datatables-buttons" type="button"><a onClick={handleRedirectAddCategory}>Thêm tin tức</a></button>
                            </div></div>
                                <div className="col-sm-12 col-md-6"><div id="datatables-buttons_filter" className="dataTables_filter">
                                    ...
                                    <thead>
                                        <tr>
                                            <th className="sorting sorting_asc" tabindex="0" aria-controls="datatables-buttons" rowspan="1" colspan="1" style={{ width: "224px" }}  >Tiêu đề tin tức</th>
                                            ...
                                            <th className="sorting sorting_asc" tabindex="0" aria-controls="datatables-buttons" rowspan="1" colspan="1">Nội dung</th>
