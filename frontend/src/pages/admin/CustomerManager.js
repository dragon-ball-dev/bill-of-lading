...
import { deleteCustomer, deleteStore, getAllCategory, getAllCustomer, getAllStore } from "../../services/fetch/ApiUtils";
...
function CustomerManager(props){
    ...
    const fetchData = () => {
        getAllCustomer(currentPage, itemsPerPage, searchQuery).then(response => {
                ...
                <div className="main">
                    ...
                    <div className="card">
                        <div className="card-header">
                            ...
                            <h6 className="card-subtitle text-muted"> Quản lý khách hàng.</h6>
                        </div>
                        <div className="card-body">
                            <div id="datatables-buttons_wrapper" className="dataTables_wrapper dt-bootstrap5 no-footer"><div className="row"><div className="col-sm-12 col-md-6"><div className="dt-buttons btn-group flex-wrap">
                                <button className="btn btn-secondary buttons-copy buttons-html5" tabindex="0" aria-controls="datatables-buttons" type="button"><a onClick={handleRedirectAddCategory}>Thêm Khách Hàng</a></button>
                            </div></div>
                                <div className="col-sm-12 col-md-6"><div id="datatables-buttons_filter" className="dataTables_filter">
                                    ...
                                    <thead>
                                        <tr>
                                            <th className="sorting sorting_asc" tabindex="0" aria-controls="datatables-buttons" rowspan="1" colspan="1" style={{ width: "224px" }}  >Tên khách hàng</th>
                                            ...
                                            <th className="sorting sorting_asc" tabindex="0" aria-controls="datatables-buttons" rowspan="1" colspan="1"  >Mã giảm giá</th>
