                ...
                <div className="main">
                    ...
                    <div className="card">
                        <div className="card-header">
                            ...
                            <h6 className="card-subtitle text-muted"> Quản lý banner của TVL Post.</h6>
                        </div>
                        <div className="card-body">
                            <div id="datatables-buttons_wrapper" className="dataTables_wrapper dt-bootstrap5 no-footer"><div className="row"><div className="col-sm-12 col-md-6"><div className="dt-buttons btn-group flex-wrap">
                                <button className="btn btn-secondary buttons-copy buttons-html5" tabindex="0" aria-controls="datatables-buttons" type="button"><a onClick={handleRedirectAddCategory}>Thêm banner</a></button>
                            </div></div>
                                <div className="col-sm-12 col-md-6"><div id="datatables-buttons_filter" className="dataTables_filter">
                                    ...
                                    <thead>
                                        <tr>
                                            <th className="sorting sorting_asc" tabindex="0" aria-controls="datatables-buttons" rowspan="1" colspan="1" style={{ width: "224px" }}  >Tên banner</th>
                                            <th className="sorting sorting_asc" tabindex="0" aria-controls="datatables-buttons" rowspan="1" colspan="1" style={{ width: "224px" }}  >Ảnh</th>
                                            <th className="sorting sorting_asc" tabindex="0" aria-controls="datatables-buttons" rowspan="1" colspan="1">Chiều dài</th>
                                            <th className="sorting sorting_asc" tabindex="0" aria-controls="datatables-buttons" rowspan="1" colspan="1">Chiều rộng</th>
                                            <th className="sorting sorting_asc" tabindex="0" aria-controls="datatables-buttons" rowspan="1" colspan="1">Trạng thái</th>
                                    ...
                                    <tbody>
                                        {tableData?.map((item) => (
                                            <tr className="odd">
                                                ...
                                                <td className="dtr-control sorting_1" tabindex="0"><img src={item.imageUrl} /></td>
                                                <td className="dtr-control sorting_1" tabindex="0">{item.height}</td>
                                                <td className="dtr-control sorting_1" tabindex="0">{item.width}</td>
                                                <td>
                                                    <button type="button" class="btn btn-outline-success">
                                                        {item.status === true ? "Hiển thị" : "Khóa"}
                                                    </button>
                                                </td>
                                                <td>
