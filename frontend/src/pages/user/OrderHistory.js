...
import { getAllCategory, getAllOrder, getAllOrderHistory, getAllOrderNew, getAllProduct } from "../../services/fetch/ApiUtils";
...
function OrderHistory(props) {
    ...
    const fetchData = () => {
        getAllOrderHistory(currentPage - 1, itemsPerPage, userId).then(response => {
