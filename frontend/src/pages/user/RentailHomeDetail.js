                                    ...
                                    <div class="row justify-content-between">
                                        ...
                                        <div class="col-md-7 col-lg-7 section-md-t3">
                                            ...
                                            <div className="col-md-12 mt-3">
                                                <a href={`/booking-homestay/`+ window.location.pathname.split("/").pop()}>
                                        ...
                                        <div class="col-md-6 col-lg-4">
                                            <div class="property-agent">
                                                ...
                                                <p class="color-text-a">
                                                    Phòng trọ luôn chất lượng đảm bảo đúng sự thật và không các chi tiết khiến người dùng thất vọng
                                                    khi đến xem và kiểm tra Phòng trọ. An ninh tuyệt đối.
                                                </p>
